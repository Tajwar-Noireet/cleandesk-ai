  ...
  return (
    <div className="ops-flow-preview">
      ...
      <div className="ops-card card-incoming animate-float-1">
        <div className="ops-card-badge" style={{ color: '#2563EB' }}>💬 Incoming Enquiry</div>
      ...
      <div className="ops-card card-matched animate-float-2">
        <div className="ops-card-badge" style={{ color: '#0A0A0A' }}>⚙️ Matching Capabilities</div>
      ...
      <div className="ops-card card-lead animate-float-3">
        <div className="ops-card-badge" style={{ color: '#16A34A' }}>🎯 Structured Lead Captured</div>
      ...
      <div className="ops-card card-outcome animate-float-1">
        <div className="ops-card-badge" style={{ color: '#D97706' }}>📋 Operations Review</div>
